...
## Project Structure
    ...
    ├── test_app_recruit_mk_38118  # Django project configurations
...
1. Clone this repo and `cd test_app_recruit_mk_38118`
...
2. Clone this repo and `cd test_app_recruit_mk_38118`
